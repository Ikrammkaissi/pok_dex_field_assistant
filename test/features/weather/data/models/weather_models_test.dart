...
void main() {
  ...
  group('WeatherData.fromJson', () {
    test('parses temperature as double', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(temperature: 22.5));
      expect(data.temperature, 22.5);
    });

    test('parses windspeed as double', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(windspeed: 18.3));
      expect(data.windspeed, 18.3);
    });

    test('parses weathercode as int', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(weathercode: 95));
      expect(data.weathercode, 95);
    });

    test('isDay is true when is_day is 1', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(isDay: 1));
      expect(data.isDay, isTrue);
    });

    test('isDay is false when is_day is 0', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(isDay: 0));
    ...
    test('accepts integer temperature (num cast)', () {
      ...
      final data = WeatherDataMapper.fromJson({
        'current_weather': {
          'temperature': 20,
          'windspeed': 10,
          'weathercode': 0,
    ...
    test('throws ParseException when current_weather is not a map', () {
      expect(
        () => WeatherDataMapper.fromJson({'current_weather': 'bad'}),
        throwsA(isA<ParseException>()),
      );
    });
  ...
  group('WeatherData.conditionLabel', () {
    test('thunderstorm for weathercode 95', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 95)).conditionLabel,
        'Thunderstorm',
      );
    });
    ...
    test('thunderstorm for weathercode 99 (upper bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 99)).conditionLabel,
        'Thunderstorm',
      );
    });
    ...
    test('snow for weathercode 71 (lower bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 71)).conditionLabel,
        'Snow',
      );
    });
    ...
    test('snow for weathercode 77 (upper bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 77)).conditionLabel,
        'Snow',
      );
    });
    ...
    test('rain for drizzle code 51 (lower bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 51)).conditionLabel,
        'Rain',
      );
    });
    ...
    test('rain for drizzle code 67 (upper bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 67)).conditionLabel,
        'Rain',
      );
    });
    ...
    test('rain for shower code 80 (lower bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 80)).conditionLabel,
        'Rain',
      );
    });
    ...
    test('rain for shower code 82 (upper bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 82)).conditionLabel,
        'Rain',
      );
    });
    ...
    test('fog for weathercode 45 (lower bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 45)).conditionLabel,
        'Fog',
      );
    });
    ...
    test('fog for weathercode 49 (upper bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 49)).conditionLabel,
        'Fog',
      );
    });
    ...
    test('clear for weathercode 0', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 0)).conditionLabel,
        'Clear',
      );
    });
    ...
    test('clear for weathercode 2 (upper bound)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 2)).conditionLabel,
        'Clear',
      );
    });
    ...
    test('cloudy for weathercode 3 (just above clear)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 3)).conditionLabel,
        'Cloudy',
      );
    });
    ...
    test('cloudy for weathercode 44 (gap before fog)', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 44)).conditionLabel,
        'Cloudy',
      );
    });
  });
  ...
  group('WeatherData.suggestedPokemonType', () {
    test('electric for thunderstorm code 95', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 95))
            .suggestedPokemonType,
        'electric',
      );
    });
    ...
    test('ice for snow code 71', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 71))
            .suggestedPokemonType,
        'ice',
      );
    });
    ...
    test('water for drizzle code 55', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 55))
            .suggestedPokemonType,
        'water',
      );
    });
    ...
    test('water for shower code 81', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 81))
            .suggestedPokemonType,
        'water',
      );
    });
    ...
    test('ghost for fog code 45', () {
      expect(
        WeatherDataMapper.fromJson(_weatherJson(weathercode: 45))
            .suggestedPokemonType,
        'ghost',
      );
    });
  ...
  group('WeatherData.conditionIcon', () {
    test('sun emoji for clear day', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(weathercode: 0, isDay: 1));
      expect(data.conditionIcon, '☀️');
    });

    test('moon emoji for clear night', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(weathercode: 0, isDay: 0));
    ...
    test('snow emoji', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(weathercode: 71));
      expect(data.conditionIcon, '❄️');
    });

    test('rain emoji', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(weathercode: 55));
      expect(data.conditionIcon, '🌧️');
    });

    test('fog emoji', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(weathercode: 45));
      expect(data.conditionIcon, '🌫️');
    });

    test('cloud emoji for cloudy', () {
      final data = WeatherDataMapper.fromJson(_weatherJson(weathercode: 3));
      expect(data.conditionIcon, '☁️');
    });
  });
}
